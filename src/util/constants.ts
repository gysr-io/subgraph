...
// factories
export let MAINNET_ERC20_COMPETITIVE_REWARD_MODULE_FACTORY = Address.fromString('0x4e06ae5fa48089a69d4ee4ffee9524b06c2b7400');
export let MAINNET_ERC20_FRIENDLY_REWARD_MODULE_FACTORY = Address.fromString('0x101063f864e91b72a5ce06342afc7ea5d8515398');

export let KOVAN_ERC20_COMPETITIVE_REWARD_MODULE_FACTORY = Address.fromString('0x5c1A02D6CAa8C954Cb30CE2B1a6C02Edd75fc3E3');
export let KOVAN_ERC20_FRIENDLY_REWARD_MODULE_FACTORY = Address.fromString('0x88fb2e8951534200411a4D6eBd7d000c225B76F0');
